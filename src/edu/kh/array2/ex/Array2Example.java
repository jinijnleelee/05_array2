...
public class Array2Example {
	...
	public void ex1()
	{
		...
		arr = new int[2][3];
		//heap 영역에 int 2차원배열 2행3열 공간을 할당
		
		//2차원 배열 초기화
		//1) 행,열,인텍스 이용해서 직접 초기화
	/*
	...
	public void ex3() {
		...
		char [][] arr = new char[4][];
		//char 2차원 배열 생성 시 행 부분시 작성
		arr[0] = new char[3]; //0행에 3열짜리 1차원 배열을 생성하여 주소값 저장
		arr[1] = new char[4]; //1행에 3열짜리 1차원 배열을 생성하여 주소값 저장
